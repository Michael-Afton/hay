...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Projectile, function (sprite, otherSprite) {
    game.splash("NO,NO NO NO", "You can not defeat me!!!")
    game.splash("finale", "Dr.bone boss battle!!!")
    pause(2000)
    mySprite4 = sprites.create(assets.image`dr bone`, SpriteKind.boss)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.Player, function (sprite, otherSprite) {
    mySprite2.destroy()
    game.splash("hmmmm, you have skills!!!")
    game.splash("I'll put you to the", "ULTIMATE TEST!!!")
    game.splash("level 3", "highway to heaven!!!!!!")
    pause(1000)
    ...
    mySprite3 = sprites.create(assets.image`the godly bone`, SpriteKind.Projectile)
    mySprite.setPosition(124, 100)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.Food, function (sprite, otherSprite) {
    mySprite.destroy()
    game.splash("great job!!!!!!!!!!!!!!!!")
    myCorg.verticalMovement()
    game.splash("level 2", "city sideline!!!")
    scene.setBackgroundImage(img`
        ...
        7777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777
        `)
    mySprite2 = sprites.create(assets.image`upgraded bone`, SpriteKind.Player)
    mySprite.setPosition(35, 47)
    game.splash("find upgraded bone!!!")
})
...
scene.setBackgroundImage(img`
    ...
    4444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444
    `)
game.splash("level 1", "forest adventure!!!")
game.splash("find set bone!!??!!")
mySprite = sprites.create(assets.image`classic bone`, SpriteKind.Food)
mySprite.setPosition(110, 112)
